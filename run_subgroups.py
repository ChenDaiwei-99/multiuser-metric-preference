...
def _per_run(args, normal_dataset):
    ...
    torch.save({'args':args, 'train_stats':train_stats, 'learner':learner}, f'./save_subgroups_new/subgroups_{args["num_groups"]}.pt')
...
if __name__ == '__main__':
    ...
    for i in param_combinations:
        ...
        args_tmp['num_groups']=i[0]
        args_tmp['ablate_alpha']=i[1]
        args_list.append(args_tmp)
    
    Parallel(n_jobs=16)(delayed(_per_run)(i,normal_dataset) for i in args_list)